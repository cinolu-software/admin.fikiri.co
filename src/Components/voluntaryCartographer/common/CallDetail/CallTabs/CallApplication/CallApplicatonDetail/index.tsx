        ...
        <div className="container-fluid">
                        ...
                        <Col md={10}>
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <p><strong>Date d'inscription:</strong> {safeFormatDate(selectedApplication.applicant?.created_at)}</p>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                            ...
                            Object.entries(selectedApplication.responses).map(([question, response], index) => (
                                <Col md={6} key={index} className="mb-3">
                                    <div className="p-3 border rounded">
                                        ...
                                        <p className="text-muted mb-0">{String(response)}</p>
                                    </div>
                                </Col>
                            ))
                        }
            ...
            <Card className="mt-4">
                <CardBody>
                    ...
                    <Row>
                        <Col md={6}>
                            <p><strong>Date de soumission:</strong> {safeFormatDate(selectedApplication.created_at, "dd MMMM yyyy à HH:mm")}</p>
                        </Col>
                        {selectedApplication.document && (
                            <Col md={6}>
                                <p>
                                    ...
                                    <a
                                        href={`${imageBaseUrl}/documents/${selectedApplication.document}`}
                                        target="_blank"
